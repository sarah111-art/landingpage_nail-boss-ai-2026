...
export default function LandingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await fetch(
        "https://script.google.com/macros/s/AKfycbyaW8uXqQSwRevq_RP_JPMrx2FDViXa7dMljsjcI9E_Hb6s4x_PyJzCOO40BL21qyMO/exec",
        {
          method: "POST",
          mode: "no-cors",
          body: data,
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
              BÍ QUYẾT{" "}
              <span className="text-gradient-gold">TƯ DUY CHỦ TIỆM</span> <br />
              & ỨNG DỤNG AI 2026
            </h1>
            <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed">
              Khởi động 2026 với chiến lược vận hành tiệm Nail bài bản, tự động
              hóa bằng AI.
            </p>
            ...
            <div className="flex justify-center items-center gap-8 md:gap-16">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400 uppercase tracking-widest">
                  Chuyên gia Setup & Vận hành Tiệm Nail
                </p>
              </div>
              <div className="text-center">
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border-2 border-[#D4AF37] p-1 mx-auto mb-3">
      ...
      <section
        id="details"
        className="py-20 bg-[#0a0a0a] border-t border-white/5"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              <h2 className="font-serif text-3xl md:text-4xl font-bold mb-8">
                ...
                <span className="text-gradient-gold">
                  Hệ thống tiệm của bạn có đang mắc kẹt trong những rào cản này?
                </span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="font-serif text-3xl md:text-5xl font-bold mb-4">
              Nội Dung{" "}
              <span className="text-gradient-gold">Chia Sẻ Độc Quyền</span>
            </h2>
          </div>
          ...
          <div className="mt-16 p-8 md:p-12 rounded-3xl bg-gradient-to-br from-[#1a1a1a] to-[#050505] border border-[#D4AF37]/20 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
              ...
              <div>
                <div className="inline-block px-4 py-1 rounded-full bg-[#D4AF37] text-black text-xs font-bold mb-4">
                  FOUNDER NAILS BOSS
                </div>
                <h3 className="font-serif text-3xl font-bold mb-2">
                  HUY NAILS BOSS - Chuyên gia Setup & Vận hành Tiệm Nail:
                </h3>
                <p className="text-gray-300 text-lg mb-4">
                  Sở hữu hơn 10 năm kinh nghiệm thực chiến dày dặn trong việc tư
                  vấn vận hành và tối ưu hóa hệ thống tiệm Nails. Đang vận hành
                  song song 5 tiệm Nails tại Mỹ. Nội dung chia sẻ dựa hoàn toàn
                  trên dữ liệu thực tế: từ việc đánh giá mặt bằng, thiết kế trải
                  nghiệm dịch vụ đến tối ưu dòng tiền quảng cáo.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 p-8 md:p-12 rounded-3xl bg-gradient-to-br from-[#1a1a1a] to-[#050505] border border-[#D4AF37]/20 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
              ...
              <div>
                ...
                <h3 className="font-serif text-3xl font-bold mb-2">
                  QUỐC NGUYỄN - Chuyên gia AI ứng dụng ngành Dịch Vụ
                </h3>
                <p className="text-gray-300 text-lg mb-4">
                  Nhà phát triển hệ thống công cụ AI thiết kế chuyên biệt cho
                  ngành Nails. Anh sẽ trực tiếp hướng dẫn cách giải phóng chủ
                  tiệm khỏi việc phụ thuộc Agency, tối ưu hóa toàn bộ ấn phẩm
                  Marketing hoàn toàn bằng AI.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-12">
            <div className="bg-[#111] p-8 rounded-2xl border border-white/10 w-full md:w-auto min-w-[250px]">
              ...
              <p className=" text-3xl font-bold text-white mt-2">04/03/2026</p>
            </div>
          ...
          <div className="bg-[#111] rounded-3xl p-8 md:p-12 border border-[#D4AF37]/30 shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-gray-400 mb-8">
                Zoom hoàn toàn{" "}
                <span className="text-[#D4AF37] font-bold">FREE</span>. Chỉ mở{" "}
                <span className="text-[#D4AF37] font-bold"> 50 suất </span>cho
                người đăng ký sớm nhất.
              </p>
              ...
              <div className="flex justify-center items-center gap-3 sm:gap-4 mt-6">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-gray-400 text-xs sm:text-sm mt-2 font-medium uppercase tracking-wider">
                    Giờ
                  </span>
                </div>

                <div className="text-[#D4AF37] text-3xl sm:text-4xl font-bold pb-6 animate-pulse">
                  :
                </div>
            ...
            {status === "success" ? (
              <div className="bg-green-500/20 border border-green-500 rounded-xl p-8 text-center text-green-400">
                ...
                <p>
                  Cảm ơn bạn. Thông tin Zoom sẽ được gửi qua Email/Zalo của bạn.
                </p>
              </div>
            ) : (
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="pt-4">
                  ...
                  <p className="text-center text-xs text-gray-500 mt-4">
                    *Thông tin của bạn được bảo mật tuyệt đối. Chúng tôi sẽ gửi
                    link Zoom qua Email/Zalo.
                  </p>
                </div>
              </form>
            )}
